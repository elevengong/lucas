...
@section("content")
    <link href="<?php echo asset( "/resources/views/backend/webuploader/webuploader.css") ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo asset( "/resources/views/backend/webuploader/style.css") ?>" rel="stylesheet" type="text/css" />
        ...
        <div class="Hui-article">
            ...
            <article class="cl pd-20">
                ...
                <span class="l">
                    ...
                    <span class="l" style="margin-left: 30px;display: none;">
                    <a href="{{url('/backend/girls/webuploader/'.$id)}}" id="btn_add_category" class="btn btn-primary radius" >
                        <i class="Hui-iconfont">&#xe600;</i> webUpload
                    </a>
                </span>
                </div>
    ...
    <script type="text/javascript" src="<?php echo asset( "/resources/views/backend/webuploader/webuploader.js") ?>"></script>
    <script>
        (function( $ ){
            // 当domReady的时候开始初始化
            $(function() {
                ...
                uploader = WebUploader.create({
                    ...
                    chunked: false,
                    chunkSize: 512 * 1024,
                    server: '/backend/girls/webuploader/{{$id}}',
                    // runtimeOrder: 'flash',
