    ...
    <form class="form form-horizontal" id="form1">
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="{{$Area['area_name']}}" id="area_name" name="area_name" />
            </div>
        </div>
        ...
        <div class="col-xs-12 row cl">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="input-text" value="{{$Area['priority']}}" id="priority" name="priority" />
            </div>
        </div>
        <div class="col-xs-12 row cl" style="text-align: center;">
            <div class="formControls col-xs-12 col-sm-12">
                <input type="button" onclick="areaeditprocess({{$Area['id']}})" class="btn btn-primary" value="修改" id="btn_add_ok" />
            </div>
        </div>
