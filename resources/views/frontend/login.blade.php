...
<div class="wrap">
    ...
    <div class="mn" id="main_message">
        <div class="bm">
            <div class="bm_h bbs">
                <span class="y"><a href="/register.html" class="xi2">没有帐号？注册</a></span>
                <h3 class="xs2">登陆</h3>
            </div>
            <div>
                ...
                <div id="main_messaqge_L4IM3">
                    <div class="loginform">
                        <div class="loginHint_wrapper">
                            <h1>登陆｜<a href="/register.html" style="color: red;">注册</a></h1>
                            <p class="bold">网站名和介绍</p>
                            <p class="normal">登陆会员帐号，体现更多乐趣。</p>
                        </div>
                        <form class="form form-horizontal" method="post" action="/login.html">
                            {{csrf_field()}}
