...
<div class="showbox wrap">
    ...
    <div class="reply">
        <form class="formPost">
            ...
            <input type="hidden" name="gid" value="3246">
            <div class="row"><textarea name="body" class="fbody" id="fbody" style="height:160px"></textarea></div>
            <div class="row face"><ul><li><img src="/resources/views/frontend/images/face/0.gif" data-name="[em0]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/1.gif" data-name="[em1]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/2.gif" data-name="[em2]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/3.gif" data-name="[em3]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/4.gif" data-name="[em4]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/5.gif" data-name="[em5]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/6.gif" data-name="[em6]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/7.gif" data-name="[em7]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/8.gif" data-name="[em8]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/9.gif" data-name="[em9]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/10.gif" data-name="[em10]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/11.gif" data-name="[em11]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/12.gif" data-name="[em12]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/13.gif" data-name="[em13]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/14.gif" data-name="[em14]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/15.gif" data-name="[em15]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/16.gif" data-name="[em16]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/17.gif" data-name="[em17]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/18.gif" data-name="[em18]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/19.gif" data-name="[em19]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/20.gif" data-name="[em20]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/21.gif" data-name="[em21]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/22.gif" data-name="[em22]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/23.gif" data-name="[em23]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/24.gif" data-name="[em24]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/25.gif" data-name="[em25]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/26.gif" data-name="[em26]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/27.gif" data-name="[em27]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/28.gif" data-name="[em28]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/29.gif" data-name="[em29]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/30.gif" data-name="[em30]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/31.gif" data-name="[em31]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/32.gif" data-name="[em32]" class="fimg"></li><li><img src="/resources/views/frontend/images/face/33.gif" data-name="[em33]" class="fimg"></li></ul></div>
            <div class="row"><label>Nickname 昵称</label><input name="nickname" ><label style="margin-left:20px;">Content 内容</label><input name="tel" placeholder="内容隐藏，Content Concealed"> <button class="btn">Submit 提交</button></div>
...
<script src="<?php echo asset( "/resources/views/frontend/js/layer.js") ?>"></script>
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on("submit",".formPost",function(){
            ...
            var that=this;
            $.post('reply.php',post_data,function(jdata){
                if (jdata.status==2){
